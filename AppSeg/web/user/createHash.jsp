<%-- 
    Document   : createHash
    Created on : 31/07/2017, 11:24:09
    Author     : Evandson
--%>
                ...
                <form action="${pageContext.request.contextPath}/controller?action=UserLogic&access=cadHash" method="post">
                    ...
                    <div class="login-fields">
                        ...
                        <div class="field">
                            ...
                            <textarea type="text" id="firstname" name="codHash" placeholder="Escreva aqui seu Texto!" rows="5" cols="50" required></textarea>
                        </div> <!-- /field -->
                    ...
                    <button class="button btn btn-primary btn-small">Criar</button>
